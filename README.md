...
```javascript
import unary2d from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-unary2d@v0.2.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/array-base-unary2d/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/array-base-unary2d/actions/workflows/test.yml?query=branch:v0.2.0
